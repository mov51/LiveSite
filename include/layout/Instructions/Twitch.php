<div id="TwitchLancher" class="center box default mb-3">
  ...
  <div class="row justify-content-center">
    <div class="col-lg-6 col-12 box dark override">
      ...
      It requires the you have accses to the internet, a purchaced minecraft java edition account, a twitch account, a modpack you want to install, and a computer to install it on. The specifications requrired for the computer will vary depending on the pack you want to play, its best to ask for minmum specs in forums for the pack.
      </p>
    </div>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-6 col-12">
                <p>
                Now that you have the installer open it. You can either click on it in your browser or navigate to your downloads folder and open it from there. <br /> Once you've opened the installer you will see a page that just says install, as you can imagine, click install. Once its finished it will automatically open the launcher and you will be asked to log in to your twitch account or sign up with a new one. Sign in with twitch and we can move on to installing the pack.
                </p>
                </div>
                <div class="col-lg-6 col-12">
